#############################################################################
# Makefile for building: 8-CHIP\ Emulator
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  8-CHIP Emulator.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile 8-CHIP\ Emulator.pro
#############################################################################
...
Makefile: 8-CHIP\ Emulator.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile 8-CHIP\ Emulator.pro
...
dist: 
	@test -d .tmp/8-CHIP\ Emulator1.0.0 || mkdir -p .tmp/8-CHIP\ Emulator1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/8-CHIP\ Emulator1.0.0/ && $(COPY_FILE) --parents chip8Core.h mainwindow.h .tmp/8-CHIP\ Emulator1.0.0/ && $(COPY_FILE) --parents chip8Core.cpp main.cpp mainwindow.cpp .tmp/8-CHIP\ Emulator1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/8-CHIP\ Emulator1.0.0/ && (cd `dirname .tmp/8-CHIP\ Emulator1.0.0` && $(TAR) 8-CHIP\ Emulator1.0.0.tar 8-CHIP\ Emulator1.0.0 && $(COMPRESS) 8-CHIP\ Emulator1.0.0.tar) && $(MOVE) `dirname .tmp/8-CHIP\ Emulator1.0.0`/8-CHIP\ Emulator1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/8-CHIP\ Emulator1.0.0
...
chip8Core.o: chip8Core.cpp chip8Core.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o chip8Core.o chip8Core.cpp
